package com.example.trackyourwalk_v2
...
import com.example.trackyourwalk_v2.databinding.ActivityMainBinding
            ...
            handler.postDelayed(Runnable {
                ...
                if(notifications){
                    if(currentSteps > 10000){
                        Toast.makeText(this, "Daily step goal reached. Steps reset!", Toast.LENGTH_LONG).show()
                        resetSteps()
                    }
                    sendNotification()
                }
